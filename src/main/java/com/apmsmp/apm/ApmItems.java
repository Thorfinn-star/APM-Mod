...
public final class ApmItems {
    ...
    public static final Item APM_SWORD = register("apm_sword", Item::new, new Item.Properties().sword(APM_TOOL, 5.5F, -2.15F));
    public static final Item APM_PICKAXE = register("apm_pickaxe", Item::new, new Item.Properties().pickaxe(APM_TOOL, 2.5F, -2.55F));
    public static final Item APM_AXE = register("apm_axe", p -> new AxeItem(APM_TOOL, 7.5F, -2.7F, p), new Item.Properties());
    public static final Item APM_SHOVEL = register("apm_shovel", p -> new ShovelItem(APM_TOOL, 2.5F, -2.7F, p), new Item.Properties());
